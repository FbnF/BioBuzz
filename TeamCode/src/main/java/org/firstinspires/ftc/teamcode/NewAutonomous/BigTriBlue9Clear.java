...
public class BigTriBlue9Clear extends LinearOpMode {
    ...
    private final Pose clearStart = new Pose(28.368, 73.405, Math.toRadians(270));
    private final Pose clearEnd = new Pose(13.098, 73.045, Math.toRadians(270));
    ...
    // Shoot and reload logic (Stable version confirmed)
